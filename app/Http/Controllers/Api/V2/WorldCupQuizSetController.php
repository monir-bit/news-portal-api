...
class WorldCupQuizSetController extends Controller
{
    ...
    public function start(WorldCupQuizStartRequest $request, string $slug): JsonResponse
    {
        $set = WorldCupQuizSet::query()
            ->activeNow()
            ->where('slug', $slug)
    ...
    public function submitAnswer(WorldCupQuizAnswerStoreRequest $request, string $slug): JsonResponse
    {
        $set = WorldCupQuizSet::query()
            ->activeNow()
            ->where('slug', $slug)
