...
class EpaperQuestionController extends Controller
{
     ...
     * @throws HttpException
     */
    public function grid(Request $request): array
    {
     ...
     * @throws HttpException
     */
    public function pageQuestions(Request $request, string $page): array
    {
