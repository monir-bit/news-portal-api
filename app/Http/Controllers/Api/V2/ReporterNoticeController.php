...
class ReporterNoticeController extends Controller
{
    ...
    public function index(Request $request): JsonResponse
    {
        ...
        $notices = $this->visibleNoticesQuery($reporter)
    ...
    public function show(int $id): JsonResponse
    {
        ...
        $notice = $this->visibleNoticesQuery($reporter)->find($id);
    ...
    /**
     * Notices visible to the given reporter: active, either for-all or assigned to
     * them, and either unpublished-gate-free or already past their publish time.
     */
    private function visibleNoticesQuery(Reporter $reporter): Builder
    {
        return ReporterNotice::with('media')
